import {
  ...
  import {  CREATE_CHANNELS_ROUTE, GET_ALL_CONTACTS_ROUTES } from "@/utils/constants";
     ...
     const createChannel =  async() => {
      ...
      try {
        ...
        if (channelName === ""){
          ...
          toast.error("Please select contacts to create channel.")
        }


        if (channelName.length > 0 && selectedContacts.length > 0){
        const response = await apiClient.post(CREATE_CHANNELS_ROUTE, {
          name: channelName,
