...
const NewDM = () => {
  const {setSelectedChatType,setSelectedChatData} = useAppStore();
    ...
    const [OpenNewContactModal, setOpenNewContactOpenModal] = useState(false);
    ...
    const selectNewContact = (contact) => {
      setOpenNewContactOpenModal(false);
  ...
  return (
    <>
        ...
        <Tooltip>
          <TooltipTrigger>
            ...
            className="text-neutral-400 font-light text-opacity-90 text-sm 
             ...
             onClick={() => setOpenNewContactOpenModal(true)}
            />
          </TooltipTrigger>
      ...
      <Dialog open={OpenNewContactModal} onOpenChange={setOpenNewContactOpenModal}>
