...
const Profile = () => {
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] flex justify-center
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="w-full">
              <Button onClick={saveChanges}
               className =
               "h-16 w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300">
                Save Changes</Button>
